package id.naturalsmp.naturalpass.placeholders;
...
public class NaturalPassExpansion extends PlaceholderExpansion {

    private final NaturalPass plugin;

    public NaturalPassExpansion(NaturalPass plugin) {
        this.plugin = plugin;
    }
