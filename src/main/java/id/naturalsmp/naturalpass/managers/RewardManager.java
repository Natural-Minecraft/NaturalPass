...
public class RewardManager {
    ...
    public RewardManager(NaturalPass plugin, ConfigManager configManager) {
        this.plugin = plugin;
    ...
    public void loadRewards() {
        ...
        FileConfiguration freeConfig = configManager.getNaturalPassFreeConfig();
        FileConfiguration premiumConfig = configManager.getNaturalPassPremiumConfig();
    ...
    public void claimRewards(Player player, PlayerData data, List<Reward> rewards,
        ...
        FileConfiguration config = isPremium ?
                configManager.getNaturalPassPremiumConfig() :
                configManager.getNaturalPassFreeConfig();
