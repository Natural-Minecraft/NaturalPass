...
import id.naturalsmp.naturalpass.gui.MissionDetailsGui;
import id.naturalsmp.naturalpass.gui.MissionEditorGui;
import id.naturalsmp.naturalpass.gui.MissionTypeSelectionGui;
...
public class MissionEditorManager {
    ...
    public MissionEditorManager(NaturalPass plugin) {
        this.plugin = plugin;
    }
