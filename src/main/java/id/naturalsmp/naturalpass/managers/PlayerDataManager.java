...
public class PlayerDataManager {
    ...
    public PlayerDataManager(NaturalPass plugin, DatabaseManager databaseManager) {
        this.plugin = plugin;
    ...
    public void loadPlayer(UUID uuid) {
        ...
        databaseManager.loadPlayerData(uuid).thenAccept(data -> {
            if (data != null) {
                ...
                plugin.getLogger().warning("Could not load player data for " + uuid + ". The player might not be able to interact with NaturalPass features until they rejoin.");
            }
        });
    }
