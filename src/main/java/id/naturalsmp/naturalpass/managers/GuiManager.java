...
import id.naturalsmp.naturalpass.gui.*;
...
public class GuiManager {
    ...
    public GuiManager(NaturalPass plugin, PlayerDataManager playerDataManager, MissionManager missionManager,
    ...
    public void openNaturalPassGUI(Player player, int page) {
        if (page < 1) page = 1;
        ...
        NaturalPassGui gui = new NaturalPassGui(plugin, player, page);
        gui.open();
    }
