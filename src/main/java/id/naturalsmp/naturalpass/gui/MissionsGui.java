...
public class MissionsGui extends BaseGui {
    ...
    public MissionsGui(NaturalPass plugin, Player player) {
    ...
    private void setupAdminResetButton(Inventory gui) {
        ...
        meta.setDisplayName(GradientColorParser.parse("&#FF5555&lForce Reset Missions"));

        List<String> lore = new ArrayList<>();
        lore.add("");
        lore.add(GradientColorParser.parse("&#FF5555&lAdmin Only"));
        lore.add(GradientColorParser.parse("&7Force reset all daily missions"));
        lore.add("");
        lore.add(GradientColorParser.parse("&#FF5555▶ CLICK TO RESET"));
    ...
    private void setupMissionEditorButton(Inventory gui) {
        ...
        meta.setDisplayName(GradientColorParser.parse("&#00AAFF&lMission Editor"));
        ...
        lore.add("");
        lore.add(GradientColorParser.parse("&#00AAFF▶ CLICK TO EDIT"));
