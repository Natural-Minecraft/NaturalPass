...
public class NaturalPassTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            } else if (args[0].equalsIgnoreCase("giveitem") && sender.hasPermission("NaturalPass.admin")) {
        ...
        } else if (args.length == 3 && sender.hasPermission("NaturalPass.admin")) {
            String subCommand = args[0].toLowerCase();
        ...
        } else if (args.length == 4 && sender.hasPermission("NaturalPass.admin")) {
            String subCommand = args[0].toLowerCase();
